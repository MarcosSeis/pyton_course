...
def main():
    ...
    if not articles:  # Si la lista está vacía, termina la ejecución
        print("No se encontraron artículos para hoy. Deteniendo la ejecución.")
        return
